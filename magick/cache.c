          ...
          (((y+v) < 0) || ((y+v) >= (long) cache_info->rows)) || (length == 0))
        {
          ...
          */
          ...
          switch (virtual_pixel_method)
          {
            ...
            {
              p=AcquireCacheNexus(image,virtual_pixel_method,EdgeX(
                cache_info->columns,x+u),EdgeY(cache_info->rows,y+v),1UL,1UL,
            ...
            {
              p=AcquireCacheNexus(image,virtual_pixel_method,DitherX(
                cache_info->columns,x+u),DitherY(cache_info->rows,y+v),1UL,1UL,
                image_nexus,exception);
              break;
            }
            ...
            {
              p=AcquireCacheNexus(image,virtual_pixel_method,MirrorX(
                cache_info->columns,x+u),MirrorY(cache_info->rows,y+v),1UL,1UL,
                image_nexus,exception);
              break;
            }
            case RandomVirtualPixelMethod:
            {
              p=AcquireCacheNexus(image,virtual_pixel_method,RandomX(
                cache_info->columns),RandomY(cache_info->rows),1UL,1UL,
                image_nexus,exception);
              break;
            }
            case TileVirtualPixelMethod:
            {
              p=AcquireCacheNexus(image,virtual_pixel_method,TileX(
                cache_info->columns,x+u),TileY(cache_info->rows,y+v),1UL,1UL,
                image_nexus,exception);
              break;
            }
