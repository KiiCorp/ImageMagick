...
MagickExport RandomInfo *DestroyRandomInfo(RandomInfo *random_info)
{
  ...
  AcquireSemaphoreInfo(&random_info->semaphore);
  ...
  random_info->semaphore=DestroySemaphoreInfo(random_info->semaphore);
...
#define MaxEntropyExtent  64
  ...
  */
...
#if defined(MAGICKCORE_HAVE_MKSTEMP)
  {
    ...
    filename=AcquireString("magickXXXXXX");
...
MagickExport double GetPseudoRandomValue(void)
{
  ...
  return((double) random_seed[0]/range);
}

/*
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
