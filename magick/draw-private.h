  ...
  const long x,const long y)
{
  ...
  fill_color=AcquireOneVirtualPixel(pattern,TileVirtualPixelMethod,
    x+pattern->tile_offset.x,y+pattern->tile_offset.y,&pattern->exception);
  return(fill_color);
}
  ...
  const long x,const long y)
{
  ...
  stroke_color=AcquireOneVirtualPixel(pattern,TileVirtualPixelMethod,
    x+pattern->tile_offset.x,y+pattern->tile_offset.y,&pattern->exception);
  return(stroke_color);
}
