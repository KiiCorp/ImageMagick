  ...
  if (LocaleCompare(image_info->magick,"MSVG") != 0)
    {
      ...
      SetImageProperty(image,"svg:base-uri",rsvg_handle_get_base_uri(svg_info));
      SetImageProperty(image,"svg:title",rsvg_handle_get_title(svg_info));
      SetImageProperty(image,"svg:description",rsvg_handle_get_desc(svg_info));
      ...
      cairo_info=cairo_create(cairo_surface);
  		...
  		rsvg_handle_render_cairo(svg_info,cairo_info);
